...
export default class CardView extends Component {
  ...
  static defaultProps = {
    ...
    scale: 1,
    fontFamily: Platform.select({ios: Font.Helvetica, android: Font.Helvetica,}),
    imageFront: require('../../../../assets/payment_card/card_front.png'),
    imageBack: require('../../../../assets/payment_card/card_back.png'),
  };
